      ...
      <View style={[margins, containerStyle]}>
        ...
        <View style={[paddings, fieldStyle]} row centerV>
          ...
          <View flex row>
            ...
            {children || <Input placeholderTextColor={hidePlaceholder ? 'transparent' : Colors.$textNeutral} {...others} style={[typographyStyle, colorStyle, others.style]} onFocus={onFocus} onBlur={onBlur} onChangeText={onChangeText} placeholder={placeholder} hint={hint} />}
          </View>
          {trailingAccessory}
          {
          /* </View> */
