...
class Card extends PureComponent {
  ...
  renderSelection() {
    ...
    const selectionColor = _get(selectionOptions, 'color', DEFAULT_SELECTION_PROPS.color);
    ...
    return <Animated.View style={[this.styles.selectedBorder, {
      ...
      opacity: animatedSelected
        ...
        backgroundColor: selectionColor
            ...
            <Icon style={this.styles.selectedIcon} source={_get(selectionOptions, 'icon', DEFAULT_SELECTION_PROPS.icon)} />
          </View>}
      </Animated.View>;
  }
